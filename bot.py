...
async def garantir_canal_config(guild):
    ...
    # Limpa mensagens antigas do bot no canal de config para evitar spam e atualiza o painel
...
async def on_ready():
    ...
    # Registra a view persistentemente para os botões nunca pararem de funcionar
